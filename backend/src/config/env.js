...
export const env = {
  ...
  liveStreamUrls: {
    dsports: process.env.LIVE_STREAM_URL_DSPORTS || '',
    dsports2: process.env.LIVE_STREAM_URL_DSPORTS2 || '',
    tyc: process.env.LIVE_STREAM_URL_TYC || '',
    telefe: process.env.LIVE_STREAM_URL_TELEFE || '',
    disney: process.env.LIVE_STREAM_URL_DISNEY || '',
    'tv-publica': process.env.LIVE_STREAM_URL_TV_PUBLICA || '',
    espn: process.env.LIVE_STREAM_URL_ESPN || '',
    'fox-sports': process.env.LIVE_STREAM_URL_FOX_SPORTS || '',
  },
