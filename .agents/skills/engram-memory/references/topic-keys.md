...
|---------|-------------------|--------|
| `mundial2026/ui/` | ranking, predictions, live-match, group-colors, match-timeline, ranking-dashboard-live, **fubols-cup-match-points** | FBL-17/19: acordeón, caché; FBL-25: PTS del cruce → docs/FUBOLS_CUP.md |
